...
const BookManagement: React.FC = () => {
    ...
    const handleEditSuccess = async (bookData: Partial<BookFormData>) => {
    ...
    return (
        <div className="book-management">
                            ...
                            <tr key={book.id}>
                                <td>
                                    <img
                                        ...
                                        onError={(e) => {
                                            e.currentTarget.src = 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=300&h=400&fit=crop';
                                        }}
                                    />
                                </td>
                                <td>
                                ...
                                <td>
                                    <div className="rating-info">
                                        ...
                                        <span className="reviews">({book.reviewCount || 0})</span>
                                    </div>
                                </td>
                                <td>
            ...
            {/* ✅ Fixed: Add Modal with onSuccess prop */}
            {showAddModal && (
                <AddBookModal
            ...
            {/* ✅ Fixed: Edit Modal with onSuccess prop */}
            {editingBook && (
                <EditBookModal
                    book={editingBook}
